...
public class FirstActivityTestTab {
    ...
    public void firstActivityTestTab() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.id_steps_detail_description), withText("Recipe Introduction"),
                        childAtPosition(
                                childAtPosition(
